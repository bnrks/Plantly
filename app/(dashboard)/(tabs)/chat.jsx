      ...
      >
        ...
        >
          <ThemedView style={styles.modalContainer}>
            <View style={styles.modalHeader}>
              <ThemedTitle style={styles.modalTitle}>Bitki Seçin</ThemedTitle>
              <TouchableOpacity
                style={styles.closeButton}
            ...
            <ThemedText style={styles.modalSubtitle}>
              Önerileri hangi bitkiye kaydetmek istiyorsunuz?
            </ThemedText>

            {isLoadingPlants ? (
              <View style={styles.loadingContainer}>
                <ThemedText>Bitkiler yükleniyor...</ThemedText>
              </View>
            ) : userPlants.length === 0 ? (
              <View style={styles.emptyContainer}>
                <Ionicons
